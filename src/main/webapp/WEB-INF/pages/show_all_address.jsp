...
<head>
    <title>所有地址</title>
    <link rel="stylesheet" href="../../css/show_all_address.css">
</head>
<body>
...
<div id="main">
    <div><a href="add_address.jsp"><input type="button" id="add_address" value="添加地址"></a></div>
    <div style="border: 1px solid greenyellow; width: 800px; height: 200px;margin-top: 20px"></div>
    <div style="border: 1px solid greenyellow; width: 800px; height: 200px;margin-top: 20px"></div>
    <div style="border: 1px solid greenyellow; width: 800px; height: 200px;margin-top: 20px"></div>
</div>
