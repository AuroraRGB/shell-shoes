...
<div id="main">
    <div id="pic">
        <img src="../../images/ChinaMap1.png">
    </div>
    <form action="${pageContext.request.contextPath}/AddressServlet">
        <div id="address">
            <div class="add">省份：<select id="provinceSel" name="province" class="sel" onchange="initCity(this)">
                <option>省份</option>
            </select>
            </div>
            <div class="add">城市：<select id="citySel" name="city" class="sel" onchange="initArea(this)">
                <option>城市</option>
            </select>
            </div>
            <div class="add">地区：<input type="text" name="area" style="width:200px; height:50px;"/>
            </div>
            <div class="add">街道：<input type="text" name="street" style="width:200px; height:50px;"/>
            </div>
            <div class="add">详细地址：<input type="text" name="detail" style="width:350px; height:50px;"/></div>
            <div class="add">邮编：<input type="text" name="code" style="width:200px; height:50px;"/> </div>
            <input type="hidden" name="type" value="0"/> <%--隐藏域--%>
            <div class="add">
                <button class="button" type="submit">添加地址</button>
            </div>
        </div>
    </form>
</div>
